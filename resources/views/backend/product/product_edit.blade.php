                ...
                <div class="row">
                    ...
                    <div class="border border-3 p-4 rounded">
                        ...
                        <div class="mb-3">
                            ...
                            <input readonly type="text" name="product_code" class="form-control" id="inputProductTitle" value="{{ $product->product_code }}">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <label for="formFile" class="form-label">OPTIONAL but If change 1 image, should change all 4 ones</label>
                            <input class="form-control" type="file"
                            name="image_one">
                        </div>
                    ...
                    <div class="border border-3 p-4 rounded">
                        ...
                        <div class="form-check form-switch">
                            <input name="soldout" class="form-check-input" type="checkbox" id="soldout" defaultValue="0" {{ $product->soldout == 0 ? '' : 'checked' }}>
                        ...
                        <div class="form-check">
                            <input name="remark" class="form-check-input" type="radio" value="BEST SELLER" id="1"
                            {{ $product->remark == 'BEST SELLER' ? 'checked' : '' }}>
                            <label class="form-check-label" for="flexCheckDefault">BEST SELLER</label>
                        </div>

                        <div class="form-check">
                            <input name="remark" class="form-check-input" type="radio" value="NEW" id="2"
                            {{ $product->remark == 'NEW' ? 'checked' : '' }}>
                            <label class="form-check-label" for="flexCheckDefault">NEW</label>
                        </div>

                        <div class="form-check">
                            <input name="remark" class="form-check-input" type="radio" value="SALE" id="3"
                            {{ $product->remark == 'SALE' ? 'checked' : '' }}>
    ...
    $(document).ready(function() {
        ...
        $('#soldout').on('change', function() {
            if($('#soldout')[0].checked) {
                ...
                $('#soldout')[0].value = 0;
                console.log($('#soldout')[0])
            }
        })

        // recently open default
        var selecCategory = $('#category')[0].value;
        // console.log($('#category')[0]);
        var product_subcategory = {!! json_encode($product->subcategory) !!};
        var subcategory = {!! json_encode($subcategory->toArray()) !!};

        var filterSubcategory = subcategory.filter(item => item['category_name'] == selecCategory);
        ...
        // make selected subcategory
        $("#subcategory").val(product_subcategory);
